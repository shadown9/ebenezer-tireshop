    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">{t("searchInventoryDescription")}</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-8">
            <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-primary font-semibold text-sm uppercase">{t("advancedTireSearch")}</span>
            </div>
          ...
          {searchResults.length > 0 ? (
            ...
            <Card className="p-12 text-center border-2 border-dashed">
              <CardContent>
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">{t("noTiresFoundTitle")}</h3>
                <p className="text-muted-foreground mb-6">
                  {t("noTiresFoundHint")}
                </p>
                <Button onClick={handleClearFilters}>{t("viewAllTires")}</Button>
              </CardContent>
            </Card>
          )}
        </div>
      ...
      <footer className="bg-gradient-modern text-secondary-foreground py-12 border-t border-secondary-foreground/10 mt-12">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm text-secondary-foreground/80">© 2025 Ebenezer Tireshop. {t("allRightsReserved")}</p>
        </div>
      </footer>
    </div>
  )
